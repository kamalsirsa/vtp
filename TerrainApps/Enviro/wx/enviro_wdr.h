...
const int ID_LAYER_ZOOM_TO = 10154;
const int ID_LAYER_SAVE = 10155;
const int ID_LAYER_CREATE = 10156;
const int ID_LAYER_REMOVE = 10157;
const int ID_LAYER_VISIBLE = 10158;
const int ID_SHADOW_VISIBLE  = 10159;
const int ID_SHOW_ALL = 10160;
const int ID_LAYER_TREE = 10161;
wxSizer *LayerDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPIN_YEAR = 10162;
const int ID_SPIN_MONTH = 10163;
const int ID_SPIN_DAY = 10164;
const int ID_SPIN_HOUR = 10165;
const int ID_SPIN_MINUTE = 10166;
const int ID_SPIN_SECOND = 10167;
const int ID_TEXT_SPEED = 10168;
const int ID_SLIDER_SPEED = 10169;
wxSizer *TimeDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FULLSCREEN = 10170;
const int ID_STEREO = 10171;
const int ID_STEREO1 = 10172;
const int ID_STEREO2 = 10173;
const int ID_WINX = 10174;
const int ID_WINY = 10175;
const int ID_WIN_XSIZE = 10176;
const int ID_WIN_YSIZE = 10177;
const int ID_SIZE_INSIDE = 10178;
const int ID_TEXTURE_COMPRESSION = 10179;
const int ID_DISABLE_MIPMAPS = 10180;
const int ID_DIRECT_PICKING = 10181;
const int ID_SELECTION_CUTOFF = 10182;
const int ID_SELECTION_RADIUS = 10183;
const int ID_PLANTSIZE = 10184;
const int ID_ONLY_AVAILABLE_SPECIES = 10185;
const int ID_CHOICE_CONTENT = 10186;
wxSizer *OptionsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FEATURE_TYPE = 10187;
const int ID_GEOMETRY = 10188;
const int ID_GEOM_COLOR = 10189;
const int ID_GEOM_HEIGHT = 10190;
const int ID_TESSELLATE = 10191;
const int ID_TEXT_LABELS = 10192;
const int ID_LABEL_COLOR = 10193;
const int ID_TEXT_FIELD = 10194;
const int ID_COLOR_FIELD = 10195;
const int ID_LABEL_HEIGHT = 10196;
const int ID_LABEL_SIZE = 10197;
wxSizer *StyleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_LIST = 10198;
const int ID_NEW_SCENARIO = 10199;
const int ID_DELETE_SCENARIO = 10200;
const int ID_EDIT_SCENARIO = 10201;
const int ID_MOVEUP_SCENARIO = 10202;
const int ID_MOVEDOWN_SCENARIO = 10203;
wxSizer *ScenariosPaneFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_VISIBLE_LAYERS = 10204;
const int ID_SCENARIO_ADD_VISIBLE_LAYER = 10205;
const int ID_SCENARIO_REMOVE_VISIBLE_LAYER = 10206;
const int ID_SCENARIO_AVAILABLE_LAYERS = 10207;
wxSizer *ScenarioVisibleLayersPane( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_NAME = 10208;
wxSizer *ScenarioParamsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_PREVIOUS = 10209;
const int ID_SCENARIO_NEXT = 10210;
