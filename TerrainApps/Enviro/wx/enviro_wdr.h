...
const int ID_STEREO = 10172;
const int ID_STEREO1 = 10173;
const int ID_STEREO2 = 10174;
const int ID_WINX = 10175;
const int ID_WINY = 10176;
const int ID_WIN_XSIZE = 10177;
const int ID_WIN_YSIZE = 10178;
const int ID_SIZE_INSIDE = 10179;
const int ID_TEXTURE_COMPRESSION = 10180;
const int ID_DISABLE_MIPMAPS = 10181;
const int ID_DIRECT_PICKING = 10182;
const int ID_SELECTION_CUTOFF = 10183;
const int ID_SELECTION_RADIUS = 10184;
const int ID_PLANTSIZE = 10185;
const int ID_ONLY_AVAILABLE_SPECIES = 10186;
const int ID_CHOICE_CONTENT = 10187;
wxSizer *OptionsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FEATURE_TYPE = 10188;
const int ID_GEOMETRY = 10189;
const int ID_GEOM_COLOR = 10190;
const int ID_GEOM_HEIGHT = 10191;
const int ID_TESSELLATE = 10192;
const int ID_TEXT_LABELS = 10193;
const int ID_LABEL_COLOR = 10194;
const int ID_TEXT_FIELD = 10195;
const int ID_COLOR_FIELD = 10196;
const int ID_LABEL_HEIGHT = 10197;
const int ID_LABEL_SIZE = 10198;
wxSizer *StyleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_LIST = 10199;
const int ID_NEW_SCENARIO = 10200;
const int ID_DELETE_SCENARIO = 10201;
const int ID_EDIT_SCENARIO = 10202;
const int ID_MOVEUP_SCENARIO = 10203;
const int ID_MOVEDOWN_SCENARIO = 10204;
wxSizer *ScenariosPaneFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_VISIBLE_LAYERS = 10205;
const int ID_SCENARIO_ADD_VISIBLE_LAYER = 10206;
const int ID_SCENARIO_REMOVE_VISIBLE_LAYER = 10207;
const int ID_SCENARIO_AVAILABLE_LAYERS = 10208;
wxSizer *ScenarioVisibleLayersPane( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_NAME = 10209;
wxSizer *ScenarioParamsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_PREVIOUS = 10210;
const int ID_SCENARIO_NEXT = 10211;
