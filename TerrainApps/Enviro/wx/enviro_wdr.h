...
const int ID_IMAGEFILES = 10109;
wxSizer *TParams2Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PLANTS = 10110;
const int ID_TREEFILE = 10111;
const int ID_VEGDISTANCE = 10112;
const int ID_ROADS = 10113;
const int ID_ROADFILE = 10114;
const int ID_ROADHEIGHT = 10115;
const int ID_ROADDISTANCE = 10116;
const int ID_TEXROADS = 10117;
const int ID_ROADCULTURE = 10118;
const int ID_HIGHWAYS = 10119;
const int ID_PAVED = 10120;
const int ID_DIRT = 10121;
const int ID_CONTENT_FILE = 10122;
const int ID_STRUCTFILES = 10123;
const int ID_STRUCT_DISTANCE = 10124;
const int ID_CHECK_STRUCTURE_SHADOWS = 10125;
const int ID_CHOICE_SHADOW_REZ = 10126;
const int ID_DARKNESS = 10127;
const int ID_VEHICLES = 10128;
wxSizer *TParams3Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_NAV_STYLE = 10129;
const int ID_MINHEIGHT = 10130;
const int ID_NAVSPEED = 10131;
const int ID_LOCFILE = 10132;
const int ID_INIT_LOCATION = 10133;
const int ID_HITHER = 10134;
const int ID_ANIM_PATHS = 10135;
const int ID_TEXT_INIT_TIME = 10136;
const int ID_SET_INIT_TIME = 10137;
const int ID_TIMEMOVES = 10138;
const int ID_TIMESPEED = 10139;
wxSizer *TParams4Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TREECTRL = 10140;
const int ID_ADD_PATH = 10141;
const int ID_ADD_TERRAIN = 10142;
const int ID_COPY = 10143;
const int ID_DELETE = 10144;
const int ID_EDIT_PARAMS = 10145;
wxSizer *TerrManFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_OCEANPLANE = 10146;
const int ID_OCEANPLANEOFFSET = 10147;
const int ID_DEPRESSOCEAN = 10148;
const int ID_DEPRESSOCEANOFFSET = 10149;
const int ID_SKY = 10150;
const int ID_SKYTEXTURE = 10151;
const int ID_HORIZON = 10152;
const int ID_FOG = 10153;
const int ID_FOG_DISTANCE = 10154;
const int ID_COLOR3 = 10155;
const int ID_BGCOLOR = 10156;
wxSizer *TParams5Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RAWFILES = 10157;
const int ID_STYLE = 10158;
const int ID_OVERLAY_FILE = 10159;
const int ID_OVERLAY_DOTDOTDOT = 10160;
const int ID_OVERLAY_X = 10161;
const int ID_OVERLAY_Y = 10162;
...
const int ID_LAYER_ZOOM_TO = 10163;
const int ID_LAYER_SAVE = 10164;
const int ID_LAYER_SAVE_AS = 10165;
const int ID_LAYER_CREATE = 10166;
const int ID_LAYER_REMOVE = 10167;
const int ID_LAYER_VISIBLE = 10168;
const int ID_SHADOW_VISIBLE  = 10169;
const int ID_SHOW_ALL = 10170;
const int ID_LAYER_TREE = 10171;
wxSizer *LayerDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPIN_YEAR = 10172;
const int ID_SPIN_MONTH = 10173;
const int ID_SPIN_DAY = 10174;
const int ID_SPIN_HOUR = 10175;
const int ID_SPIN_MINUTE = 10176;
const int ID_SPIN_SECOND = 10177;
const int ID_TEXT_SPEED = 10178;
const int ID_SLIDER_SPEED = 10179;
wxSizer *TimeDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FULLSCREEN = 10180;
const int ID_STEREO = 10181;
const int ID_STEREO1 = 10182;
const int ID_STEREO2 = 10183;
const int ID_WINX = 10184;
const int ID_WINY = 10185;
const int ID_WIN_XSIZE = 10186;
const int ID_WIN_YSIZE = 10187;
const int ID_SIZE_INSIDE = 10188;
const int ID_TEXTURE_COMPRESSION = 10189;
const int ID_DISABLE_MIPMAPS = 10190;
const int ID_DIRECT_PICKING = 10191;
const int ID_SELECTION_CUTOFF = 10192;
const int ID_SELECTION_RADIUS = 10193;
const int ID_PLANTSIZE = 10194;
const int ID_ONLY_AVAILABLE_SPECIES = 10195;
const int ID_CHOICE_CONTENT = 10196;
wxSizer *OptionsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FEATURE_TYPE = 10197;
const int ID_GEOMETRY = 10198;
const int ID_GEOM_COLOR = 10199;
const int ID_GEOM_HEIGHT = 10200;
const int ID_LINE_WIDTH = 10201;
const int ID_TESSELLATE = 10202;
const int ID_TEXT_LABELS = 10203;
const int ID_LABEL_COLOR = 10204;
const int ID_TEXT_FIELD = 10205;
const int ID_COLOR_FIELD = 10206;
