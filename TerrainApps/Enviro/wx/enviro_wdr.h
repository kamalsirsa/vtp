...
const int ID_CHOICE_TILESIZE = 10093;
...
const int ID_LAYER_SAVE_AS = 10163;
...
const int ID_LINE_WIDTH = 10199;
const int ID_TESSELLATE = 10200;
const int ID_TEXT_LABELS = 10201;
const int ID_LABEL_COLOR = 10202;
const int ID_TEXT_FIELD = 10203;
const int ID_COLOR_FIELD = 10204;
const int ID_LABEL_HEIGHT = 10205;
const int ID_LABEL_SIZE = 10206;
wxSizer *StyleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_LIST = 10207;
const int ID_NEW_SCENARIO = 10208;
const int ID_DELETE_SCENARIO = 10209;
const int ID_EDIT_SCENARIO = 10210;
const int ID_MOVEUP_SCENARIO = 10211;
const int ID_MOVEDOWN_SCENARIO = 10212;
wxSizer *ScenariosPaneFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_VISIBLE_LAYERS = 10213;
const int ID_SCENARIO_ADD_VISIBLE_LAYER = 10214;
const int ID_SCENARIO_REMOVE_VISIBLE_LAYER = 10215;
const int ID_SCENARIO_AVAILABLE_LAYERS = 10216;
wxSizer *ScenarioVisibleLayersPane( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_NAME = 10217;
wxSizer *ScenarioParamsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_PREVIOUS = 10218;
const int ID_SCENARIO_NEXT = 10219;
wxSizer *ScenarioSelectDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PANEL1 = 10220;
const int ID_TARGET = 10221;
const int ID_CURRENT = 10222;
const int ID_CACHE_USED = 10223;
const int ID_TILE_LOADS = 10224;
const int ID_TILE_HITS = 10225;
