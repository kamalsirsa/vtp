...
const int ID_VERTEXAG = 10082;
wxSizer *TParams1Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_NONE = 10083;
const int ID_SINGLE = 10084;
const int ID_TFILESINGLE = 10085;
const int ID_DERIVED = 10086;
const int ID_CHOICE_COLORS = 10087;
const int ID_EDIT_COLORS = 10088;
const int ID_TILED = 10089;
const int ID_TILESIZE = 10090;
const int ID_TFILEBASE = 10091;
const int ID_JPEG = 10092;
const int ID_TFILENAME = 10093;
const int ID_MIPMAP = 10094;
const int ID_16BIT = 10095;
const int ID_PRELIGHT = 10096;
const int ID_LIGHT_FACTOR = 10097;
const int ID_CAST_SHADOWS = 10098;
const int ID_DETAILTEXTURE = 10099;
const int ID_DT_NAME = 10100;
const int ID_DT_SCALE = 10101;
const int ID_DT_DISTANCE = 10102;
wxSizer *TParams2Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PLANTS = 10103;
const int ID_TREEFILE = 10104;
const int ID_VEGDISTANCE = 10105;
const int ID_ROADS = 10106;
const int ID_ROADFILE = 10107;
const int ID_ROADHEIGHT = 10108;
const int ID_ROADDISTANCE = 10109;
const int ID_TEXROADS = 10110;
const int ID_ROADCULTURE = 10111;
const int ID_HIGHWAYS = 10112;
const int ID_PAVED = 10113;
const int ID_DIRT = 10114;
const int ID_CONTENT_FILE = 10115;
const int ID_STRUCTFILES = 10116;
const int ID_STRUCT_DISTANCE = 10117;
const int ID_CHECK_STRUCTURE_SHADOWS = 10118;
const int ID_CHOICE_SHADOW_REZ = 10119;
const int ID_DARKNESS = 10120;
const int ID_VEHICLES = 10121;
wxSizer *TParams3Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_NAV_STYLE = 10122;
const int ID_MINHEIGHT = 10123;
const int ID_NAVSPEED = 10124;
const int ID_LOCFILE = 10125;
const int ID_INIT_LOCATION = 10126;
const int ID_HITHER = 10127;
const int ID_ANIM_PATHS = 10128;
const int ID_TEXT_INIT_TIME = 10129;
const int ID_SET_INIT_TIME = 10130;
const int ID_TIMEMOVES = 10131;
const int ID_TIMESPEED = 10132;
wxSizer *TParams4Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TREECTRL = 10133;
const int ID_ADD_PATH = 10134;
const int ID_ADD_TERRAIN = 10135;
const int ID_COPY = 10136;
const int ID_DELETE = 10137;
const int ID_EDIT_PARAMS = 10138;
wxSizer *TerrManFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_OCEANPLANE = 10139;
const int ID_OCEANPLANEOFFSET = 10140;
const int ID_DEPRESSOCEAN = 10141;
const int ID_DEPRESSOCEANOFFSET = 10142;
const int ID_SKY = 10143;
const int ID_SKYTEXTURE = 10144;
const int ID_HORIZON = 10145;
const int ID_FOG = 10146;
const int ID_FOG_DISTANCE = 10147;
const int ID_COLOR3 = 10148;
const int ID_BGCOLOR = 10149;
wxSizer *TParams5Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RAWFILES = 10150;
const int ID_STYLE = 10151;
const int ID_OVERLAY_FILE = 10152;
const int ID_OVERLAY_DOTDOTDOT = 10153;
const int ID_OVERLAY_X = 10154;
const int ID_OVERLAY_Y = 10155;
...
const int ID_LAYER_ZOOM_TO = 10156;
const int ID_LAYER_SAVE = 10157;
const int ID_LAYER_CREATE = 10158;
const int ID_LAYER_REMOVE = 10159;
const int ID_LAYER_VISIBLE = 10160;
const int ID_SHADOW_VISIBLE  = 10161;
const int ID_SHOW_ALL = 10162;
const int ID_LAYER_TREE = 10163;
wxSizer *LayerDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPIN_YEAR = 10164;
const int ID_SPIN_MONTH = 10165;
const int ID_SPIN_DAY = 10166;
const int ID_SPIN_HOUR = 10167;
const int ID_SPIN_MINUTE = 10168;
const int ID_SPIN_SECOND = 10169;
const int ID_TEXT_SPEED = 10170;
const int ID_SLIDER_SPEED = 10171;
wxSizer *TimeDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FULLSCREEN = 10172;
const int ID_STEREO = 10173;
const int ID_STEREO1 = 10174;
const int ID_STEREO2 = 10175;
const int ID_WINX = 10176;
const int ID_WINY = 10177;
const int ID_WIN_XSIZE = 10178;
const int ID_WIN_YSIZE = 10179;
const int ID_SIZE_INSIDE = 10180;
const int ID_TEXTURE_COMPRESSION = 10181;
const int ID_DISABLE_MIPMAPS = 10182;
const int ID_DIRECT_PICKING = 10183;
const int ID_SELECTION_CUTOFF = 10184;
const int ID_SELECTION_RADIUS = 10185;
const int ID_PLANTSIZE = 10186;
const int ID_ONLY_AVAILABLE_SPECIES = 10187;
const int ID_CHOICE_CONTENT = 10188;
wxSizer *OptionsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FEATURE_TYPE = 10189;
const int ID_GEOMETRY = 10190;
const int ID_GEOM_COLOR = 10191;
const int ID_GEOM_HEIGHT = 10192;
const int ID_TESSELLATE = 10193;
const int ID_TEXT_LABELS = 10194;
const int ID_LABEL_COLOR = 10195;
const int ID_TEXT_FIELD = 10196;
const int ID_COLOR_FIELD = 10197;
const int ID_LABEL_HEIGHT = 10198;
const int ID_LABEL_SIZE = 10199;
wxSizer *StyleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_LIST = 10200;
const int ID_NEW_SCENARIO = 10201;
const int ID_DELETE_SCENARIO = 10202;
const int ID_EDIT_SCENARIO = 10203;
const int ID_MOVEUP_SCENARIO = 10204;
const int ID_MOVEDOWN_SCENARIO = 10205;
wxSizer *ScenariosPaneFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_VISIBLE_LAYERS = 10206;
const int ID_SCENARIO_ADD_VISIBLE_LAYER = 10207;
const int ID_SCENARIO_REMOVE_VISIBLE_LAYER = 10208;
const int ID_SCENARIO_AVAILABLE_LAYERS = 10209;
wxSizer *ScenarioVisibleLayersPane( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_NAME = 10210;
wxSizer *ScenarioParamsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SCENARIO_PREVIOUS = 10211;
const int ID_SCENARIO_NEXT = 10212;
