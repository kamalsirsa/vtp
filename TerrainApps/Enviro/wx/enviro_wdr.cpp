...
wxSizer *TParamsFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    ScenariosPaneFunc( item12, FALSE );
    item5->AddPage( item12, _("Scenarios") );
...
wxSizer *TParams2Func( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticBox *item49 = new wxStaticBox( parent, -1, _("Image Layers") );
    wxStaticBoxSizer *item48 = new wxStaticBoxSizer( item49, wxVERTICAL );

    wxString *strs50 = (wxString*) NULL;
    wxListBox *item50 = new wxListBox( parent, ID_IMAGEFILES, wxDefaultPosition, wxDefaultSize, 0, strs50, wxLB_SINGLE );
    item48->Add( item50, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item36->Add( item48, 1, wxGROW|wxALL, 5 );
...
wxSizer *TParams4Func( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticText *item31 = new wxStaticText( parent, ID_TEXT, _("Initial Time: "), wxDefaultPosition, wxDefaultSize, 0 );
    item30->Add( item31, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxTextCtrl *item32 = new wxTextCtrl( parent, ID_TEXT_INIT_TIME, wxT(""), wxDefaultPosition, wxSize(80,-1), wxTE_READONLY );
    item30->Add( item32, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxButton *item33 = new wxButton( parent, ID_SET_INIT_TIME, _("Set"), wxDefaultPosition, wxDefaultSize, 0 );
    item30->Add( item33, 0, wxALIGN_CENTER|wxALL, 5 );

    item28->Add( item30, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxBoxSizer *item34 = new wxBoxSizer( wxHORIZONTAL );

    wxCheckBox *item35 = new wxCheckBox( parent, ID_TIMEMOVES, _("Time Moves"), wxDefaultPosition, wxDefaultSize, 0 );
    item34->Add( item35, 0, wxALIGN_CENTER|wxALL, 5 );
    ...
    wxStaticText *item37 = new wxStaticText( parent, ID_TEXT, _("Faster than real: "), wxDefaultPosition, wxDefaultSize, 0 );
    item36->Add( item37, 0, wxALIGN_CENTER|wxALL, 0 );

    wxTextCtrl *item38 = new wxTextCtrl( parent, ID_TIMESPEED, wxT(""), wxDefaultPosition, wxSize(60,-1), 0 );
...
wxSizer *TParams6Func( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxString *strs3 = (wxString*) NULL;
    wxListBox *item3 = new wxListBox( parent, ID_RAWFILES, wxDefaultPosition, wxSize(80,120), 0, strs3, wxLB_SINGLE );
    item1->Add( item3, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxButton *item4 = new wxButton( parent, ID_STYLE, _("Style..."), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item4, 0, wxALIGN_CENTER|wxALL, 5 );

    item0->Add( item1, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxStaticBox *item6 = new wxStaticBox( parent, -1, _("Window Overlay (HUD)") );
...
wxSizer *LayerDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxButton *item2 = new wxButton( parent, ID_LAYER_ZOOM_TO, _("Zoom To"), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item2, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item3 = new wxButton( parent, ID_LAYER_SAVE, _("Save"), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item3, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item4 = new wxButton( parent, ID_LAYER_SAVE_AS, _("Save As..."), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item4, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item5 = new wxButton( parent, ID_LAYER_CREATE, _("Create"), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item5, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item6 = new wxButton( parent, ID_LAYER_REMOVE, _("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxCheckBox *item8 = new wxCheckBox( parent, ID_LAYER_VISIBLE, _("Visible"), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item8, 0, wxALIGN_CENTER|wxALL, 5 );

    wxCheckBox *item9 = new wxCheckBox( parent, ID_SHADOW_VISIBLE , _("Shadow"), wxDefaultPosition, wxDefaultSize, 0 );
...
void LayerToolBarFunc( wxToolBar *parent )
{
    ...
    parent->AddTool( ID_LAYER_SAVE_AS, _("Save As"), ToolBitmapsFunc( 3 ), wxNullBitmap, wxITEM_NORMAL, _("Save Layer As...") );
    parent->AddTool( ID_LAYER_DELETE, _("Delete"), ToolBitmapsFunc( 6 ), wxNullBitmap, wxITEM_NORMAL, _("Delete Layer") );
    parent->AddSeparator();
    parent->AddTool( ID_LAYER_ZOOM_TO, _("Zoom"), ToolBitmapsFunc( 10 ), wxNullBitmap, wxITEM_NORMAL, _("Zoom to Layer") );
    parent->AddTool( ID_LAYER_VISIBLE, _("Visible"), ToolBitmapsFunc( 7 ), wxNullBitmap, wxITEM_CHECK, _("Toggle Layer Visibility") );
    parent->AddTool( ID_LAYER_SHADOW, _("Shadow"), ToolBitmapsFunc( 8 ), wxNullBitmap, wxITEM_CHECK, _("Toggle Structure Shadow") );
    parent->AddSeparator();
    parent->AddTool( ID_SHOW_ALL, _("All"), ToolBitmapsFunc( 9 ), wxNullBitmap, wxITEM_CHECK, _("Show all elements of every layer") );
