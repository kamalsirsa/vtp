...
wxSizer *CameraDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticText *item36 = new wxStaticText( parent, ID_TEXT, _("LOD distance for Vegetation"), wxDefaultPosition, wxDefaultSize, 0 );
    item35->Add( item36, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item37 = new wxTextCtrl( parent, ID_LOD_VEG, wxT(""), wxDefaultPosition, wxSize(60,-1), 0 );
    item35->Add( item37, 0, wxALIGN_CENTER, 5 );

    wxSlider *item38 = new wxSlider( parent, ID_SLIDER_VEG, 0, 0, 100, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );
    item35->Add( item38, 0, wxALIGN_CENTER, 0 );

    item0->Add( item35, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5 );

    wxBoxSizer *item39 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item40 = new wxStaticText( parent, ID_TEXT, _("LOD distance for Structures"), wxDefaultPosition, wxDefaultSize, 0 );
    item39->Add( item40, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item41 = new wxTextCtrl( parent, ID_LOD_STRUCT, wxT(""), wxDefaultPosition, wxSize(60,-1), 0 );
    item39->Add( item41, 0, wxALIGN_CENTER, 5 );

    wxSlider *item42 = new wxSlider( parent, ID_SLIDER_STRUCT, 0, 0, 100, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );
    item39->Add( item42, 0, wxALIGN_CENTER, 0 );

    item0->Add( item39, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP, 5 );

    wxBoxSizer *item43 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item44 = new wxStaticText( parent, ID_TEXT, _("LOD distance for Roads"), wxDefaultPosition, wxDefaultSize, 0 );
    item43->Add( item44, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT|wxBOTTOM, 5 );

    wxTextCtrl *item45 = new wxTextCtrl( parent, ID_LOD_ROAD, wxT(""), wxDefaultPosition, wxSize(60,-1), 0 );
    item43->Add( item45, 0, wxALIGN_CENTER, 5 );

    wxSlider *item46 = new wxSlider( parent, ID_SLIDER_ROAD, 0, 0, 100, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );
    item43->Add( item46, 0, wxALIGN_CENTER, 0 );

    item0->Add( item43, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5 );
...
wxSizer *TParams2Func( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item24 = new wxCheckBox( parent, ID_MIPMAP, _("Mipmapping"), wxDefaultPosition, wxDefaultSize, 0 );
    item23->Add( item24, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxCheckBox *item25 = new wxCheckBox( parent, ID_16BIT, _("Request 16-bit"), wxDefaultPosition, wxDefaultSize, 0 );
    item23->Add( item25, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item22->Add( item23, 0, wxALIGN_CENTER_HORIZONTAL, 5 );

    wxBoxSizer *item26 = new wxBoxSizer( wxVERTICAL );

    wxCheckBox *item27 = new wxCheckBox( parent, ID_PRELIGHT, _("Precompute lighting"), wxDefaultPosition, wxDefaultSize, 0 );
    item26->Add( item27, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxBoxSizer *item28 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item29 = new wxStaticText( parent, ID_TEXT, _("Lighting factor: "), wxDefaultPosition, wxDefaultSize, 0 );
    item28->Add( item29, 0, wxALIGN_CENTER|wxALL, 0 );

    wxTextCtrl *item30 = new wxTextCtrl( parent, ID_LIGHT_FACTOR, wxT(""), wxDefaultPosition, wxSize(60,-1), 0 );
    item28->Add( item30, 0, wxALIGN_CENTER|wxALL, 0 );

    item26->Add( item28, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxCheckBox *item31 = new wxCheckBox( parent, ID_CAST_SHADOWS, _("Cast shadows"), wxDefaultPosition, wxDefaultSize, 0 );
    item26->Add( item31, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item22->Add( item26, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 0 );

    item1->Add( item22, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5 );

    wxBoxSizer *item32 = new wxBoxSizer( wxHORIZONTAL );

    wxCheckBox *item33 = new wxCheckBox( parent, ID_RETAIN, _("Retain loaded texture in memory for faster re-lighting"), wxDefaultPosition, wxDefaultSize, 0 );
    item32->Add( item33, 0, wxALIGN_CENTER|wxALL, 5 );

    item1->Add( item32, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5 );

    item0->Add( item1, 2, wxALL, 5 );

    wxBoxSizer *item34 = new wxBoxSizer( wxVERTICAL );

    wxStaticBox *item36 = new wxStaticBox( parent, -1, _("Detail Texture") );
    wxStaticBoxSizer *item35 = new wxStaticBoxSizer( item36, wxVERTICAL );

    wxCheckBox *item37 = new wxCheckBox( parent, ID_DETAILTEXTURE, _("Show detail texture"), wxDefaultPosition, wxDefaultSize, 0 );
    item35->Add( item37, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxString *strs38 = (wxString*) NULL;
    wxComboBox *item38 = new wxComboBox( parent, ID_DT_NAME, wxT(""), wxDefaultPosition, wxSize(100,-1), 0, strs38, wxCB_DROPDOWN );
    item35->Add( item38, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxBoxSizer *item39 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item40 = new wxStaticText( parent, ID_TEXT, _("Scale"), wxDefaultPosition, wxDefaultSize, 0 );
    item39->Add( item40, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item41 = new wxTextCtrl( parent, ID_DT_SCALE, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    item39->Add( item41, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT|wxTOP, 5 );

    item35->Add( item39, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxStaticText *item42 = new wxStaticText( parent, ID_TEXT, _("(meter size of detail texture)"), wxDefaultPosition, wxDefaultSize, 0 );
    item35->Add( item42, 0, wxALIGN_CENTER|wxALL, 5 );

    wxBoxSizer *item43 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item44 = new wxStaticText( parent, ID_TEXT, _("Distance"), wxDefaultPosition, wxDefaultSize, 0 );
    item43->Add( item44, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item45 = new wxTextCtrl( parent, ID_DT_DISTANCE, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    item43->Add( item45, 0, wxALIGN_CENTER|wxALL, 5 );

    item35->Add( item43, 0, wxALIGN_CENTER_VERTICAL, 5 );

    item34->Add( item35, 0, wxGROW|wxALL, 5 );

    wxStaticBox *item47 = new wxStaticBox( parent, -1, _("Image Layers") );
    wxStaticBoxSizer *item46 = new wxStaticBoxSizer( item47, wxVERTICAL );

    wxString *strs48 = (wxString*) NULL;
    wxListBox *item48 = new wxListBox( parent, ID_IMAGEFILES, wxDefaultPosition, wxDefaultSize, 0, strs48, wxLB_SINGLE );
    item46->Add( item48, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item34->Add( item46, 1, wxGROW|wxALL, 5 );

    item0->Add( item34, 1, wxGROW|wxALIGN_CENTER_HORIZONTAL, 5 );
...
wxSizer *StyleDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item5 = new wxCheckBox( parent, ID_GEOMETRY, _("Geometry"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item9 = new wxStaticText( parent, ID_TEXT, _("Color:"), wxDefaultPosition, wxDefaultSize, 0 );
    item8->Add( item9, 0, wxALIGN_CENTER|wxALL, 5 );

    wxBitmapButton *item10 = new wxBitmapButton( parent, ID_GEOM_COLOR, MyBitmapsFunc( 0 ), wxDefaultPosition, wxDefaultSize );
    item8->Add( item10, 0, wxALIGN_CENTER|wxALL, 5 );

    item6->Add( item8, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 0 );

    wxBoxSizer *item11 = new wxBoxSizer( wxHORIZONTAL );

    item11->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxStaticText *item12 = new wxStaticText( parent, ID_TEXT, _("Height above ground"), wxDefaultPosition, wxDefaultSize, 0 );
    item11->Add( item12, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item13 = new wxTextCtrl( parent, ID_GEOM_HEIGHT, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    item11->Add( item13, 0, wxALIGN_CENTER|wxALL, 5 );

    wxStaticText *item14 = new wxStaticText( parent, ID_TEXT, _("meters"), wxDefaultPosition, wxDefaultSize, 0 );
    item11->Add( item14, 0, wxALIGN_CENTER|wxALL, 5 );

    item6->Add( item11, 0, wxALIGN_CENTER_VERTICAL, 0 );

    wxBoxSizer *item15 = new wxBoxSizer( wxHORIZONTAL );

    item15->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxStaticText *item16 = new wxStaticText( parent, ID_TEXT, _("Line width"), wxDefaultPosition, wxDefaultSize, 0 );
    item15->Add( item16, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item17 = new wxTextCtrl( parent, ID_LINE_WIDTH, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    item15->Add( item17, 0, wxALIGN_CENTER|wxALL, 5 );

    wxStaticText *item18 = new wxStaticText( parent, ID_TEXT, _("pixels"), wxDefaultPosition, wxDefaultSize, 0 );
    item15->Add( item18, 0, wxALIGN_CENTER|wxALL, 5 );

    item6->Add( item15, 0, wxALIGN_CENTER_VERTICAL, 0 );

    wxBoxSizer *item19 = new wxBoxSizer( wxHORIZONTAL );

    item19->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxCheckBox *item20 = new wxCheckBox( parent, ID_TESSELLATE, _("Tessellate edges"), wxDefaultPosition, wxDefaultSize, 0 );
    item19->Add( item20, 0, wxALIGN_CENTER|wxALL, 5 );

    item6->Add( item19, 0, wxALIGN_CENTER_VERTICAL, 0 );

    item4->Add( item6, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT|wxBOTTOM, 5 );

    wxCheckBox *item21 = new wxCheckBox( parent, ID_TEXT_LABELS, _("Text Labels"), wxDefaultPosition, wxDefaultSize, 0 );
    item4->Add( item21, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5 );
    ...
    wxBitmapButton *item26 = new wxBitmapButton( parent, ID_LABEL_COLOR, MyBitmapsFunc( 0 ), wxDefaultPosition, wxDefaultSize );
    ...
    wxStaticText *item28 = new wxStaticText( parent, ID_TEXT, _("Text field:"), wxDefaultPosition, wxDefaultSize, 0 );
    item27->Add( item28, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs29 = (wxString*) NULL;
    wxChoice *item29 = new wxChoice( parent, ID_TEXT_FIELD, wxDefaultPosition, wxSize(160,-1), 0, strs29, 0 );
    item27->Add( item29, 1, wxALIGN_CENTER|wxALL, 5 );

    item22->Add( item27, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5 );

    wxBoxSizer *item30 = new wxBoxSizer( wxHORIZONTAL );

    item30->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxStaticText *item31 = new wxStaticText( parent, ID_TEXT, _("Color field:"), wxDefaultPosition, wxDefaultSize, 0 );
    item30->Add( item31, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs32 = (wxString*) NULL;
    wxChoice *item32 = new wxChoice( parent, ID_COLOR_FIELD, wxDefaultPosition, wxSize(160,-1), 0, strs32, 0 );
    item30->Add( item32, 1, wxALIGN_CENTER|wxALL, 5 );

    item22->Add( item30, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5 );

    wxBoxSizer *item33 = new wxBoxSizer( wxHORIZONTAL );

    item33->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxStaticText *item34 = new wxStaticText( parent, ID_TEXT, _("Height above ground"), wxDefaultPosition, wxDefaultSize, 0 );
    item33->Add( item34, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item35 = new wxTextCtrl( parent, ID_LABEL_HEIGHT, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    item33->Add( item35, 0, wxALIGN_CENTER|wxALL, 5 );

    wxStaticText *item36 = new wxStaticText( parent, ID_TEXT, _("meters"), wxDefaultPosition, wxDefaultSize, 0 );
    item33->Add( item36, 0, wxALIGN_CENTER|wxALL, 5 );

    item22->Add( item33, 0, wxALIGN_CENTER_VERTICAL, 5 );

    wxBoxSizer *item37 = new wxBoxSizer( wxHORIZONTAL );

    item37->Add( 20, 20, 0, wxALIGN_CENTER, 5 );

    wxStaticText *item38 = new wxStaticText( parent, ID_TEXT, _("Label Size (vertical)"), wxDefaultPosition, wxDefaultSize, 0 );
    item37->Add( item38, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item39 = new wxTextCtrl( parent, ID_LABEL_SIZE, wxT(""), wxDefaultPosition, wxSize(80,-1), 0 );
    ...
    wxCheckBox *item44 = new wxCheckBox( parent, ID_TEXTURE_OVERLAY, _("Texture Overlay"), wxDefaultPosition, wxDefaultSize, 0 );
    item4->Add( item44, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5 );

    wxStaticBox *item46 = new wxStaticBox( parent, -1, wxT("") );
    ...
    wxStaticText *item48 = new wxStaticText( parent, ID_TEXT, _("Mode:"), wxDefaultPosition, wxDefaultSize, 0 );
    item47->Add( item48, 0, wxALIGN_CENTER|wxALL, 5 );
    ...
    wxChoice *item49 = new wxChoice( parent, ID_TEXTURE_MODE, wxDefaultPosition, wxSize(160,-1), 1, strs49, 0 );
    item47->Add( item49, 1, wxALIGN_CENTER|wxALL, 5 );

    item45->Add( item47, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5 );

    item4->Add( item45, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5 );
    ...
    wxButton *item52 = new wxButton( parent, wxID_CANCEL, _("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    item50->Add( item52, 0, wxALIGN_CENTER|wxALL, 5 );

    item0->Add( item50, 0, wxALIGN_CENTER, 5 );
