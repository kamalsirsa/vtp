...
const int ID_OMIT_FLAT = 10196;
const int ID_MASK_UNKNOWN = 10197;
...
const int ID_AMBIENT = 10207;
const int ID_GAMMA = 10208;
...
const int ID_MAX_MEGAPIXELS = 10223;
const int ID_RADIO6 = 10224;
const int ID_RADIO7 = 10225;
const int ID_RADIO8 = 10226;
const int ID_RADIO9 = 10227;
const int ID_RADIO10 = 10228;
const int ID_RADIO11 = 10229;
const int ID_ELEV_MAX_SIZE = 10230;
const int ID_SAMPLING_N = 10231;
const int ID_BLACK_TRANSP = 10232;
const int ID_DEFLATE_TIFF = 10233;
const int ID_BT_GZIP = 10234;
wxSizer *PrefDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_DIST_CUTOFF = 10235;
...
const int ID_VIEW_LAYER_UP = 10236;
const int ID_VIEW_LAYER_DOWN = 10237;
