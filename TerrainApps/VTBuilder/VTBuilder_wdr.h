...
const int ID_AREAX = 10087;
const int ID_AREAY = 10088;
const int ID_ESTX = 10089;
const int ID_ESTY = 10090;
wxSizer *ResampleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_CONDITION = 10091;
const int ID_COMBO_VALUE = 10092;
wxSizer *SelectDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_SHOW = 10093;
const int ID_CHOICE_SHOW = 10094;
const int ID_TEXT_VERTICAL = 10095;
const int ID_CHOICE_VERTICAL = 10096;
const int ID_DEL_HIGH = 10097;
const int ID_LIST = 10098;
wxSizer *FeatInfoDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TOOLBAR = 10099;
const int ID_MINUTES = 10100;
const int ID_ELEVUNIT = 10101;
const int ID_RADIO_OUTLINE_ONLY = 10102;
const int ID_RADIO_COLOR = 10103;
const int ID_RENDER_OPTIONS = 10104;
...
const int ID_RADIO_SHADING_NONE = 10196;
const int ID_RADIO_SHADING_QUICK = 10197;
const int ID_RADIO_SHADING_DOT = 10198;
const int ID_SPIN_CAST_ANGLE = 10199;
const int ID_SPIN_CAST_DIRECTION = 10200;
const int ID_CHECK_SHADOWS = 10201;
