...
const int ID_HEIGHT_USE_FIELD = 10119;
const int ID_HEIGHT_FIELD = 10120;
wxSizer *VegFieldsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TYPE_LINEAR = 10121;
const int ID_TYPE_INSTANCE = 10122;
const int ID_CHOICE_FILE_FIELD = 10123;
const int ID_TYPE_CENTER = 10124;
const int ID_TYPE_FOOTPRINT = 10125;
const int ID_CHOICE_HEIGHT_FIELD = 10126;
const int ID_CHOICE_HEIGHT_TYPE = 10127;
const int ID_RADIO_COLOR_DEFAULT = 10128;
const int ID_RADIO_COLOR_FIXED = 10129;
const int ID_COLOR3 = 10130;
const int ID_SET_COLOR1 = 10131;
const int ID_COLOR4 = 10132;
const int ID_SET_COLOR2 = 10133;
const int ID_RADIO_ROOF_DEFAULT = 10134;
const int ID_RADIO_ROOF_SINGLE = 10135;
const int ID_CHOICE_ROOF_TYPE = 10136;
const int ID_SLOPECNTR = 10137;
const int ID_RADIO_ROOF_FIELD = 10138;
const int ID_CHOICE_ROOF_FIELD = 10139;
const int ID_DEFAULTS_FILE = 10140;
const int ID_INSIDE_AREA = 10141;
wxSizer *ImportStructFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LAYERNAME = 10142;
const int ID_ELEVATION_FIELDNAME = 10143;
const int ID_ELEVATION_UNITS = 10144;
const int ID_TYPE_BUILDING = 10145;
const int ID_BUILD_FOUNDATIONS = 10146;
const int ID_USE_25D = 10147;
wxSizer *ImportStructFuncOGR( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LEVEL_CHOICE = 10148;
wxSizer *LevelSelectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TILING = 10149;
wxSizer *SampleImageDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_BASE_URL = 10150;
const int ID_QUERY_LAYERS = 10151;
const int ID_LIST_LAYERS = 10152;
const int ID_LAYER_DESC = 10153;
const int ID_LIST_STYLES = 10154;
const int ID_STYLE_DESC = 10155;
const int ID_CHOICE_FORMAT = 10156;
const int ID_QUERY = 10157;
wxSizer *MapServerDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLITTER1 = 10158;
wxSizer *SpeciesListFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LISTCTRL_SPECIES = 10159;
wxSizer *Species1Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LISTCTRL_APPEARANCES = 10160;
wxSizer *Species2Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_THEME = 10161;
const int ID_MPP = 10162;
wxSizer *TSDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_GEOTIFF = 10163;
const int ID_JPEG = 10164;
const int ID_CHOICE_COLORS = 10165;
const int ID_EDIT_COLORS = 10166;
const int ID_SHADING = 10167;
wxSizer *RenderBitmapDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LINK_FIELD = 10168;
wxSizer *ImageMapDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EASTING = 10169;
const int ID_NORTHING = 10170;
const int ID_SET_CRS = 10171;
const int ID_FORMAT_DECIMAL = 10172;
const int ID_FORMAT_DMS = 10173;
const int ID_LONGITUDE_WEST = 10174;
wxSizer *ImportPointDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FILE_DATA = 10175;
const int ID_GET_FILE_DATA = 10176;
const int ID_CHECK_USE1 = 10177;
const int ID_CHECK_USE2 = 10178;
const int ID_FILE_GAZ = 10179;
const int ID_GET_FILE_GAZ = 10180;
const int ID_FILE_ZIP = 10181;
const int ID_GET_FILE_ZIP = 10182;
const int ID_CHECK_USE3 = 10183;
const int ID_FILE_GNS = 10184;
const int ID_GET_FILE_GNS = 10185;
wxSizer *GeocodeDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_DEPTH = 10186;
const int ID_MAXERROR = 10187;
wxSizer *ChunkDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_TO_FOLDER = 10188;
const int ID_COLUMNS = 10189;
const int ID_ROWS = 10190;
const int ID_CHOICE_LOD0_SIZE = 10191;
const int ID_SPIN_NUM_LODS = 10192;
const int ID_TOTALX = 10193;
