...
const int ID_MASK_UNKNOWN = 10195;
...
const int ID_ELEV_MAX_SIZE = 10227;
const int ID_SAMPLING_N = 10228;
const int ID_BLACK_TRANSP = 10229;
const int ID_DEFLATE_TIFF = 10230;
const int ID_BT_GZIP = 10231;
wxSizer *PrefDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_DIST_CUTOFF = 10232;
...
const int ID_VIEW_LAYER_UP = 10233;
const int ID_VIEW_LAYER_DOWN = 10234;
