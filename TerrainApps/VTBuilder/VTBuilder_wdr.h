...
const int ID_SURFTYPE = 10057;
wxSizer *RoadPropDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_INTTYPE = 10058;
const int ID_ROADNUM = 10059;
const int ID_BEHAVIOR = 10060;
const int ID_SCROLLED = 10061;
wxSizer *NodePropDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIO_CREATE_NEW = 10062;
const int ID_RADIO_TO_FILE = 10063;
const int ID_TEXT_TO_FILE = 10064;
const int ID_DOTDOTDOT = 10065;
const int ID_RADIO_TO_TILES = 10066;
const int ID_TEXT_TILE_INFO = 10067;
const int ID_TILE_OPTIONS = 10068;
const int ID_SPACINGX = 10069;
const int ID_SPACINGY = 10070;
const int ID_SIZEX = 10071;
const int ID_SIZEY = 10072;
const int ID_CONSTRAIN = 10073;
const int ID_SMALLER = 10074;
const int ID_BIGGER = 10075;
const int ID_FLOATS = 10076;
const int ID_SHORTS = 10077;
const int ID_AREAX = 10078;
const int ID_AREAY = 10079;
const int ID_ESTX = 10080;
const int ID_ESTY = 10081;
wxSizer *ResampleDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_CONDITION = 10082;
const int ID_COMBO_VALUE = 10083;
wxSizer *SelectDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_SHOW = 10084;
const int ID_CHOICE_SHOW = 10085;
const int ID_TEXT_VERTICAL = 10086;
const int ID_CHOICE_VERTICAL = 10087;
const int ID_DEL_HIGH = 10088;
const int ID_LIST = 10089;
wxSizer *FeatInfoDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TOOLBAR = 10090;
const int ID_MINUTES = 10091;
const int ID_ELEVUNIT = 10092;
const int ID_RADIO_OUTLINE_ONLY = 10093;
const int ID_RADIO_COLOR = 10094;
const int ID_RADIO_NO_SHADING = 10095;
const int ID_RADIO_SIMPLE_SHADING = 10096;
const int ID_RADIO_CAST_SHADOWS = 10097;
const int ID_SPIN_CAST_ANGLE = 10098;
const int ID_SPIN_CAST_DIRECTION = 10099;
...
const int ID_HEIGHT_USE_FIELD = 10113;
const int ID_HEIGHT_FIELD = 10114;
wxSizer *VegFieldsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TYPE_CENTER = 10115;
const int ID_TYPE_FOOTPRINT = 10116;
const int ID_FLIP = 10117;
const int ID_CHOICE_HEIGHT_FIELD = 10118;
const int ID_CHOICE_HEIGHT_TYPE = 10119;
const int ID_TYPE_LINEAR = 10120;
const int ID_TYPE_INSTANCE = 10121;
const int ID_CHOICE_FILE_FIELD = 10122;
const int ID_INSIDE_AREA = 10123;
wxSizer *ImportStructFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LAYERNAME = 10124;
const int ID_ELEVATION_FIELDNAME = 10125;
const int ID_ELEVATION_UNITS = 10126;
const int ID_TYPE_BUILDING = 10127;
const int ID_BUILD_FOUNDATIONS = 10128;
const int ID_USE_25D = 10129;
wxSizer *ImportStructFuncOGR( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LEVEL_CHOICE = 10130;
wxSizer *LevelSelectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TILING = 10131;
wxSizer *SampleImageDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_BASE_URL = 10132;
const int ID_QUERY_LAYERS = 10133;
const int ID_LIST_LAYERS = 10134;
const int ID_LAYER_DESC = 10135;
const int ID_LIST_STYLES = 10136;
const int ID_STYLE_DESC = 10137;
const int ID_CHOICE_FORMAT = 10138;
const int ID_QUERY = 10139;
wxSizer *MapServerDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLITTER1 = 10140;
wxSizer *SpeciesListFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LISTCTRL_SPECIES = 10141;
wxSizer *Species1Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LISTCTRL_APPEARANCES = 10142;
wxSizer *Species2Func( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_THEME = 10143;
const int ID_MPP = 10144;
wxSizer *TSDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_GEOTIFF = 10145;
const int ID_JPEG = 10146;
const int ID_CHOICE_COLORS = 10147;
const int ID_EDIT_COLORS = 10148;
const int ID_SHADING = 10149;
wxSizer *RenderBitmapDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LINK_FIELD = 10150;
wxSizer *ImageMapDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EASTING = 10151;
const int ID_NORTHING = 10152;
const int ID_SET_CRS = 10153;
const int ID_FORMAT_DECIMAL = 10154;
const int ID_FORMAT_DMS = 10155;
const int ID_LONGITUDE_WEST = 10156;
wxSizer *ImportPointDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_FILE_DATA = 10157;
const int ID_GET_FILE_DATA = 10158;
const int ID_CHECK_USE1 = 10159;
const int ID_CHECK_USE2 = 10160;
const int ID_FILE_GAZ = 10161;
const int ID_GET_FILE_GAZ = 10162;
const int ID_FILE_ZIP = 10163;
const int ID_GET_FILE_ZIP = 10164;
const int ID_CHECK_USE3 = 10165;
const int ID_FILE_GNS = 10166;
const int ID_GET_FILE_GNS = 10167;
wxSizer *GeocodeDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_DEPTH = 10168;
const int ID_MAXERROR = 10169;
wxSizer *ChunkDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_TO_FOLDER = 10170;
const int ID_COLUMNS = 10171;
const int ID_ROWS = 10172;
const int ID_CHOICE_LOD0_SIZE = 10173;
const int ID_SPIN_NUM_LODS = 10174;
const int ID_TOTALX = 10175;
const int ID_TOTALY = 10176;
const int ID_CURX = 10177;
const int ID_CURY = 10178;
