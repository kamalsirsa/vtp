...
const int ID_MASK_UNKNOWN = 10196;
const int ID_TC_NONE = 10197;
const int ID_TC_OGL = 10198;
const int ID_TC_SQUISH_FAST = 10199;
const int ID_TC_SQUISH_SLOW = 10200;
wxSizer *TileDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIO_SHADING_NONE = 10201;
const int ID_RADIO_SHADING_QUICK = 10202;
const int ID_RADIO_SHADING_DOT = 10203;
const int ID_SPIN_CAST_ANGLE = 10204;
const int ID_SPIN_CAST_DIRECTION = 10205;
const int ID_AMBIENT = 10206;
const int ID_GAMMA = 10207;
const int ID_CHECK_SHADOWS = 10208;
wxSizer *RenderOptionsDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EXTENT1 = 10209;
const int ID_EXTENT2 = 10210;
const int ID_MATCH_LAYER = 10211;
const int ID_LAYER_RES = 10212;
const int ID_GROW = 10213;
const int ID_SHRINK = 10214;
const int ID_TILE_SIZE = 10215;
const int ID_SIZE_SPIN = 10216;
wxSizer *MatchDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIO1 = 10217;
const int ID_RADIO2 = 10218;
const int ID_RADIO3 = 10219;
const int ID_RADIO4 = 10220;
const int ID_RADIO5 = 10221;
const int ID_MAX_MEGAPIXELS = 10222;
