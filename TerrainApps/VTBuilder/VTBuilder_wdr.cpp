...
wxSizer *BuildingDialog2Func( wxWindow *parent, bool call_fit, bool set_sizer )
{
    wxBoxSizer *item0 = new wxBoxSizer( wxVERTICAL );
    ...
    wxStaticBitmap *item22 = new wxStaticBitmap( parent, ID_COLOR, MyBitmapsFunc( 0 ), wxDefaultPosition, wxSize(32,18) );
