...
wxSizer *OptionsDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticBox *item2 = new wxStaticBox( parent, -1, _("Status Bar") );
    wxStaticBoxSizer *item1 = new wxStaticBoxSizer( item2, wxVERTICAL );

    wxCheckBox *item3 = new wxCheckBox( parent, ID_MINUTES, _("Show minutes and seconds for degree values"), wxDefaultPosition, wxDefaultSize, 0 );
    item1->Add( item3, 0, wxALIGN_CENTER|wxALL, 5 );

    wxBoxSizer *item4 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item5 = new wxStaticText( parent, ID_TEXT, _("Show elevation values as:"), wxDefaultPosition, wxDefaultSize, 0 );
    item4->Add( item5, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs6 = (wxString*) NULL;
    wxChoice *item6 = new wxChoice( parent, ID_ELEVUNIT, wxDefaultPosition, wxSize(100,-1), 0, strs6, 0 );
    item4->Add( item6, 1, wxALIGN_CENTER|wxALL, 5 );
    ...
    wxStaticBox *item8 = new wxStaticBox( parent, -1, _("Elevation") );
    wxStaticBoxSizer *item7 = new wxStaticBoxSizer( item8, wxVERTICAL );

    wxRadioButton *item9 = new wxRadioButton( parent, ID_RADIO_OUTLINE_ONLY, _("Show outline only (faster, saves memory)"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item7->Add( item9, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item10 = new wxRadioButton( parent, ID_RADIO_COLOR, _("Artificial color by elevation value"), wxDefaultPosition, wxDefaultSize, 0 );
    item7->Add( item10, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxFlexGridSizer *item11 = new wxFlexGridSizer( 2, 0, 0 );

    item11->Add( 20, 5, 0, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item12 = new wxButton( parent, ID_RENDER_OPTIONS, _("Rendering options..."), wxDefaultPosition, wxDefaultSize, 0 );
    item11->Add( item12, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item11->Add( 20, 5, 0, wxALIGN_CENTER|wxALL, 5 );

    wxCheckBox *item13 = new wxCheckBox( parent, ID_CHECK_HIDE_UNKNOWN, _("Hide areas of unknown elevation"), wxDefaultPosition, wxDefaultSize, 0 );
...
wxSizer *ImportStructFuncOGR( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticBox *item12 = new wxStaticBox( parent, -1, _("Structure type") );
    wxStaticBoxSizer *item11 = new wxStaticBoxSizer( item12, wxVERTICAL );

    wxRadioButton *item13 = new wxRadioButton( parent, ID_TYPE_BUILDING, _("Buildings"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item11->Add( item13, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
    ...
    wxCheckBox *item15 = new wxCheckBox( parent, ID_BUILD_FOUNDATIONS, _("Build foundations"), wxDefaultPosition, wxDefaultSize, 0 );
    item14->Add( item15, 0, wxALIGN_CENTER|wxALL, 5 );

    item11->Add( item14, 0, wxALIGN_CENTER_VERTICAL, 5 );

    wxRadioButton *item16 = new wxRadioButton( parent, ID_TYPE_LINEAR, _("Linear (fences or walls)"), wxDefaultPosition, wxDefaultSize, 0 );
    item11->Add( item16, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item17 = new wxRadioButton( parent, ID_TYPE_INSTANCE, _("Instances (external model references)"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item19 = new wxStaticText( parent, ID_TEXT, _("Filename field:"), wxDefaultPosition, wxDefaultSize, 0 );
    item18->Add( item19, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs20 = (wxString*) NULL;
    wxChoice *item20 = new wxChoice( parent, ID_CHOICE_FILE_FIELD, wxDefaultPosition, wxSize(100,-1), 0, strs20, 0 );
    item18->Add( item20, 0, wxALIGN_CENTER|wxALL, 5 );

    item11->Add( item18, 0, wxALIGN_CENTER_VERTICAL, 5 );

    item0->Add( item11, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxStaticBox *item22 = new wxStaticBox( parent, -1, _("Options") );
    wxStaticBoxSizer *item21 = new wxStaticBoxSizer( item22, wxVERTICAL );

    wxCheckBox *item23 = new wxCheckBox( parent, ID_INSIDE_AREA, _("Only import features inside the Area Tool extents"), wxDefaultPosition, wxDefaultSize, 0 );
    item21->Add( item23, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxCheckBox *item24 = new wxCheckBox( parent, ID_USE_25D, _("Use 2.5D for elevation"), wxDefaultPosition, wxDefaultSize, 0 );
...
wxSizer *ImportPointDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item8 = new wxCheckBox( parent, ID_CHECK_ELEVATION, _("Elevation field:"), wxDefaultPosition, wxDefaultSize, 0 );
    item7->Add( item8, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs9 = (wxString*) NULL;
    wxChoice *item9 = new wxChoice( parent, ID_ELEVATION, wxDefaultPosition, wxSize(160,-1), 0, strs9, 0 );
    item7->Add( item9, 0, wxALIGN_CENTER|wxALL, 5 );

    item0->Add( item7, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxBoxSizer *item10 = new wxBoxSizer( wxHORIZONTAL );

    wxCheckBox *item11 = new wxCheckBox( parent, ID_CHECK_IMPORT_FIELD, _("Import field directly:"), wxDefaultPosition, wxDefaultSize, 0 );
    item10->Add( item11, 0, wxALIGN_CENTER|wxALL, 5 );

    wxString *strs12 = (wxString*) NULL;
    wxChoice *item12 = new wxChoice( parent, ID_IMPORT_FIELD, wxDefaultPosition, wxSize(160,-1), 0, strs12, 0 );
    ...
    wxStaticText *item14 = new wxStaticText( parent, ID_TEXT, _("CRS:"), wxDefaultPosition, wxDefaultSize, 0 );
    item13->Add( item14, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item15 = new wxTextCtrl( parent, ID_CRS, wxT(""), wxDefaultPosition, wxSize(180,-1), 0 );
    item13->Add( item15, 1, wxALIGN_CENTER|wxALL, 5 );

    wxButton *item16 = new wxButton( parent, ID_SET_CRS, _("Set"), wxDefaultPosition, wxSize(40,-1), 0 );
    item13->Add( item16, 0, wxALIGN_CENTER|wxALL, 5 );

    item0->Add( item13, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

    wxStaticBox *item18 = new wxStaticBox( parent, -1, _("Number format:") );
    wxStaticBoxSizer *item17 = new wxStaticBoxSizer( item18, wxVERTICAL );

    wxRadioButton *item19 = new wxRadioButton( parent, ID_FORMAT_DECIMAL, _("Decimal"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item17->Add( item19, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item20 = new wxRadioButton( parent, ID_FORMAT_DMS, _("Packed degrees: DDDMMSSSS"), wxDefaultPosition, wxDefaultSize, 0 );
    item17->Add( item20, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item21 = new wxRadioButton( parent, ID_FORMAT_HDM, _("Hemisphere Degrees Minutes: HDDD MM.MMM"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxCheckBox *item23 = new wxCheckBox( parent, ID_LONGITUDE_WEST, _("Longitude is west"), wxDefaultPosition, wxDefaultSize, 0 );
    item22->Add( item23, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item0->Add( item22, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5 );
...
wxSizer *PrefDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticBox *item4 = new wxStaticBox( parent, -1, _("When importing data that lacks a CRS:") );
    wxStaticBoxSizer *item3 = new wxStaticBoxSizer( item4, wxVERTICAL );

    wxRadioButton *item5 = new wxRadioButton( parent, ID_RADIO1, _("Use the current CRS"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item3->Add( item5, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item6 = new wxRadioButton( parent, ID_RADIO2, _("Ask"), wxDefaultPosition, wxDefaultSize, 0 );
    item3->Add( item6, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item2->Add( item3, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxStaticBox *item8 = new wxStaticBox( parent, -1, _("When loading an image which is very large:") );
    wxStaticBoxSizer *item7 = new wxStaticBoxSizer( item8, wxVERTICAL );

    wxRadioButton *item9 = new wxRadioButton( parent, ID_RADIO3, _("Load it into memory"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item7->Add( item9, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item10 = new wxRadioButton( parent, ID_RADIO4, _("Use out-of-core access"), wxDefaultPosition, wxSize(220,-1), 0 );
    item7->Add( item10, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item11 = new wxRadioButton( parent, ID_RADIO5, _("Ask"), wxDefaultPosition, wxDefaultSize, 0 );
    item7->Add( item11, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxBoxSizer *item12 = new wxBoxSizer( wxHORIZONTAL );

    wxStaticText *item13 = new wxStaticText( parent, ID_TEXT, _("Large image is more than:"), wxDefaultPosition, wxDefaultSize, 0 );
    item12->Add( item13, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item14 = new wxTextCtrl( parent, ID_MAX_MEGAPIXELS, wxT(""), wxDefaultPosition, wxSize(32,-1), 0 );
    item12->Add( item14, 0, wxALIGN_CENTER|wxTOP|wxBOTTOM, 5 );

    wxStaticText *item15 = new wxStaticText( parent, ID_TEXT, _("megapixels"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item17 = new wxStaticText( parent, ID_TEXT, _("Imagery: N > 1 for NxN multisampling"), wxDefaultPosition, wxDefaultSize, 0 );
    item16->Add( item17, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item18 = new wxTextCtrl( parent, ID_SAMPLING_N, wxT(""), wxDefaultPosition, wxSize(40,-1), 0 );
    item16->Add( item18, 0, wxALIGN_CENTER|wxALL, 5 );
    ...
    wxCheckBox *item20 = new wxCheckBox( parent, ID_BLACK_TRANSP, _("Treat black as transparent when sampling images"), wxDefaultPosition, wxDefaultSize, 0 );
    item19->Add( item20, 0, wxALIGN_CENTER|wxALL, 5 );

    wxCheckBox *item21 = new wxCheckBox( parent, ID_DEFLATE_TIFF, _("Deflate TIFF images when writing"), wxDefaultPosition, wxDefaultSize, 0 );
    item19->Add( item21, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item2->Add( item19, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT|wxBOTTOM, 5 );

    item1->Add( item2, 0, wxALIGN_CENTER, 5 );

    wxBoxSizer *item22 = new wxBoxSizer( wxVERTICAL );

    wxStaticBox *item24 = new wxStaticBox( parent, -1, _("When reprojecting an integer elevation grid:") );
    wxStaticBoxSizer *item23 = new wxStaticBoxSizer( item24, wxVERTICAL );

    wxRadioButton *item25 = new wxRadioButton( parent, ID_RADIO6, _("Leave it as integer"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item23->Add( item25, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item26 = new wxRadioButton( parent, ID_RADIO7, _("Upgrade it to floating-point values"), wxDefaultPosition, wxSize(220,-1), 0 );
    item23->Add( item26, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item27 = new wxRadioButton( parent, ID_RADIO8, _("Ask"), wxDefaultPosition, wxDefaultSize, 0 );
    item23->Add( item27, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    item22->Add( item23, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxStaticBox *item29 = new wxStaticBox( parent, -1, _("Filling unknown areas of elevation grids:") );
    wxStaticBoxSizer *item28 = new wxStaticBoxSizer( item29, wxVERTICAL );

    wxRadioButton *item30 = new wxRadioButton( parent, ID_RADIO9, _("Fast"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    item28->Add( item30, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item31 = new wxRadioButton( parent, ID_RADIO10, _("Slow and smooth"), wxDefaultPosition, wxDefaultSize, 0 );
    item28->Add( item31, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxRadioButton *item32 = new wxRadioButton( parent, ID_RADIO11, _("Extrapolation via partial derivatives"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item34 = new wxStaticText( parent, ID_TEXT, _("Maximum size for rendered elevation layers:"), wxDefaultPosition, wxDefaultSize, 0 );
    item33->Add( item34, 0, wxALIGN_CENTER|wxALL, 5 );

    wxTextCtrl *item35 = new wxTextCtrl( parent, ID_ELEV_MAX_SIZE, wxT(""), wxDefaultPosition, wxSize(40,-1), 0 );
    item33->Add( item35, 0, wxALIGN_CENTER|wxALL, 5 );

    item22->Add( item33, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT, 5 );
