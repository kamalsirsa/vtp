...
#define ID_TEXT 1000
#define ID_EXTENT_N 1001
#define ID_EXTENT_W 1002
#define ID_EXTENT_E 1003
#define ID_EXTENT_S 1004
#define ID_DMS 1005
#define ID_EXTENT_ALL 1006
#define ID_BYTES 1007
#define ID_WIDTH 1008
#define ID_HEIGHT 1009
#define ID_LITTLE_ENDIAN 1010
#define ID_BIG_ENDIAN 1011
#define ID_VUNITS 1012
#define ID_CRS_SIMPLE 1013
#define ID_CRS_CURRENT 1014
#define ID_CRS_EXACT 1015
#define ID_CRS 1016
#define ID_EXT_SPACING 1017
#define ID_SPACING 1018
#define ID_EXT_EXACT 1019
#define ID_EXTENTS 1020
#define ID_PROPS 1021
#define ID_LEFT 1022
#define ID_TOP 1023
#define ID_RIGHT 1024
#define ID_BOTTOM 1025
#define ID_FIELD 1026
#define ID_DENSITY 1027
#define ID_BIOTYPE1 1028
#define ID_BIOTYPE2 1029
#define ID_SAMPLING 1030
#define ID_SCARCITY 1031
#define ID_SPECIES1 1032
#define ID_CHOICE_SPECIES 1033
#define ID_SPECIES2 1034
#define ID_CHOICE_BIOTYPE 1035
#define ID_SPECIES3 1036
#define ID_CHOICE_BIOTYPE_LAYER 1037
#define ID_DENSITY1 1038
#define ID_TEXT_FIXED_DENSITY 1039
#define ID_DENSITY2 1040
#define ID_DENSITY3 1041
#define ID_CHOICE_DENSITY_LAYER 1042
#define ID_SIZE1 1043
#define ID_TEXT_FIXED_SIZE 1044
#define ID_SIZE2 1045
#define ID_SPIN_RANDOM_FROM 1046
#define ID_SPIN_RANDOM_TO 1047
#define ID_TOWER_XY 1048
#define ID_TOWER_TYPE 1049
#define ID_TOWER_MATERIAL 1050
#define ID_TOWER_ELEV 1051
#define ID_NUMLANES 1052
#define ID_HWYNAME 1053
#define ID_SIDEWALK 1054
#define ID_PARKING 1055
#define ID_MARGIN 1056
#define ID_LANE_WIDTH 1057
#define ID_SIDEWALK_WIDTH 1058
#define ID_CURB_HEIGHT 1059
#define ID_PARKING_WIDTH 1060
#define ID_MARGIN_WIDTH 1061
#define ID_SURFTYPE 1062
#define ID_INTTYPE 1063
#define ID_ROADNUM 1064
#define ID_BEHAVIOR 1065
#define ID_SCROLLED 1066
#define ID_RADIO_CREATE_NEW 1067
#define ID_RADIO_TO_FILE 1068
#define ID_TEXT_TO_FILE 1069
#define ID_DOTDOTDOT 1070
#define ID_RADIO_TO_TILES 1071
#define ID_TEXT_TILE_INFO 1072
#define ID_TILE_OPTIONS 1073
#define ID_DERIVED_IMAGES 1074
#define ID_RENDERING_OPTIONS 1075
#define ID_TEXT_TO_IMAGE_FILE 1076
#define ID_DOTDOTDOT2 1077
#define ID_SPACINGX 1078
#define ID_SPACINGY 1079
#define ID_SIZEX 1080
#define ID_SIZEY 1081
#define ID_CONSTRAIN 1082
#define ID_SMALLER 1083
#define ID_BIGGER 1084
#define ID_FLOATS 1085
#define ID_SHORTS 1086
#define ID_FILL_GAPS 1087
#define ID_AREAX 1088
#define ID_AREAY 1089
#define ID_ESTX 1090
#define ID_ESTY 1091
#define ID_CONDITION 1092
#define ID_COMBO_VALUE 1093
#define ID_MINUTES 1094
#define ID_ELEVUNIT 1095
#define ID_RADIO_OUTLINE_ONLY 1096
#define ID_RADIO_COLOR 1097
#define ID_RENDER_OPTIONS 1098
#define ID_CHECK_HIDE_UNKNOWN 1099
#define ID_CHECK_DRAW_TIN_SIMPLE 1100
#define ID_CHECK_SHOW_ROAD_WIDTH 1101
#define ID_CHECK_DRAW_RAW_SIMPLE 1102
#define ID_PATHNAMES 1103
#define ID_USE_SPECIES 1104
#define ID_SPECIES_CHOICE 1105
#define ID_SPECIES_USE_FIELD 1106
#define ID_SPECIES_FIELD 1107
#define ID_SPECIES_ID 1108
#define ID_SPECIES_NAME 1109
#define ID_COMMON_NAME 1110
#define ID_BIOTYPE_INT 1111
#define ID_BIOTYPE_STRING 1112
#define ID_HEIGHT_RANDOM 1113
#define ID_HEIGHT_FIXED 1114
#define ID_HEIGHT_FIXED_VALUE 1115
#define ID_HEIGHT_USE_FIELD 1116
#define ID_HEIGHT_FIELD 1117
#define ID_TYPE_LINEAR 1118
#define ID_TYPE_INSTANCE 1119
#define ID_CHOICE_FILE_FIELD 1120
#define ID_TYPE_CENTER 1121
#define ID_TYPE_FOOTPRINT 1122
#define ID_CHOICE_HEIGHT_FIELD 1123
#define ID_CHOICE_HEIGHT_TYPE 1124
#define ID_RADIO_COLOR_DEFAULT 1125
#define ID_RADIO_COLOR_FIXED 1126
#define ID_COLOR3 1127
#define ID_SET_COLOR1 1128
#define ID_COLOR4 1129
#define ID_SET_COLOR2 1130
#define ID_RADIO_ROOF_DEFAULT 1131
#define ID_RADIO_ROOF_SINGLE 1132
#define ID_CHOICE_ROOF_TYPE 1133
#define ID_SLOPECNTR 1134
#define ID_RADIO_ROOF_FIELD 1135
#define ID_CHOICE_ROOF_FIELD 1136
#define ID_DEFAULTS_FILE 1137
#define ID_INSIDE_AREA 1138
#define ID_LAYERNAME 1139
#define ID_TYPE_BUILDING 1140
#define ID_BUILD_FOUNDATIONS 1141
#define ID_USE_25D 1142
#define ID_LEVEL_CHOICE 1143
#define ID_TILING 1144
#define ID_BASE_URL 1145
#define ID_QUERY_LAYERS 1146
#define ID_LIST_LAYERS 1147
#define ID_LAYER_DESC 1148
#define ID_LIST_STYLES 1149
#define ID_STYLE_DESC 1150
#define ID_CHOICE_FORMAT 1151
#define ID_QUERY 1152
#define ID_SPLITTER1 1153
#define ID_LISTCTRL_SPECIES 1154
#define ID_LISTCTRL_APPEARANCES 1155
#define ID_THEME 1156
#define ID_MPP 1157
#define ID_GEOTIFF 1158
#define ID_JPEG 1159
#define ID_CHOICE_COLORS 1160
#define ID_EDIT_COLORS 1161
#define ID_SHADING 1162
#define ID_COLOR_NODATA 1163
#define ID_LINK_FIELD 1164
#define ID_EASTING 1165
#define ID_NORTHING 1166
#define ID_CHECK_ELEVATION 1167
#define ID_ELEVATION 1168
#define ID_CHECK_IMPORT_FIELD 1169
#define ID_IMPORT_FIELD 1170
#define ID_SET_CRS 1171
#define ID_FORMAT_DECIMAL 1172
#define ID_FORMAT_DMS 1173
#define ID_FORMAT_HDM 1174
#define ID_LONGITUDE_WEST 1175
#define ID_FILE_DATA 1176
#define ID_GET_FILE_DATA 1177
#define ID_CHECK_USE1 1178
#define ID_CHECK_USE2 1179
#define ID_FILE_GAZ 1180
#define ID_GET_FILE_GAZ 1181
#define ID_FILE_ZIP 1182
#define ID_GET_FILE_ZIP 1183
#define ID_CHECK_USE3 1184
#define ID_FILE_GNS 1185
#define ID_GET_FILE_GNS 1186
#define ID_DEPTH 1187
#define ID_MAXERROR 1188
#define ID_TEXT_TO_FOLDER 1189
#define ID_COLUMNS 1190
#define ID_ROWS 1191
#define ID_CHOICE_LOD0_SIZE 1192
#define ID_SPIN_NUM_LODS 1193
#define ID_TOTALX 1194
#define ID_TOTALY 1195
#define ID_CURX 1196
#define ID_CURY 1197
#define ID_OMIT_FLAT 1198
#define ID_MASK_UNKNOWN 1199
#define ID_TC_NONE 1200
#define ID_TC_OGL 1201
#define ID_TC_SQUISH_FAST 1202
#define ID_TC_SQUISH_SLOW 1203
#define ID_TC_JPEG 1204
#define ID_RADIO_SHADING_NONE 1205
#define ID_RADIO_SHADING_QUICK 1206
#define ID_RADIO_SHADING_DOT 1207
#define ID_SPIN_CAST_ANGLE 1208
#define ID_SPIN_CAST_DIRECTION 1209
#define ID_AMBIENT 1210
#define ID_GAMMA 1211
#define ID_CHECK_SHADOWS 1212
#define ID_EXTENT1 1213
#define ID_EXTENT2 1214
#define ID_MATCH_LAYER 1215
#define ID_LAYER_RES 1216
#define ID_GROW 1217
#define ID_SHRINK 1218
#define ID_TILE_SIZE 1219
#define ID_SIZE_SPIN 1220
#define ID_RADIO1 1221
#define ID_RADIO2 1222
#define ID_RADIO3 1223
#define ID_RADIO4 1224
#define ID_RADIO5 1225
#define ID_MAX_MEGAPIXELS 1226
#define ID_SAMPLING_N 1227
#define ID_BLACK_TRANSP 1228
#define ID_DEFLATE_TIFF 1229
#define ID_RADIO6 1230
#define ID_RADIO7 1231
#define ID_RADIO8 1232
#define ID_RADIO9 1233
#define ID_RADIO10 1234
#define ID_RADIO11 1235
#define ID_ELEV_MAX_SIZE 1236
#define ID_BT_GZIP 1237
...
///////////////////////////////////////////////////////////////////////////////
/// Class ResampleDlgBase
///////////////////////////////////////////////////////////////////////////////
class ResampleDlgBase : public wxDialog 
{
	private:
	...
	protected:
		...
		wxCheckBox* m_derived_images;
		wxButton* m_rendering_options;
		
		wxTextCtrl* m_text_to_image_file;
		wxButton* m_dotdotdot2;
	...
	public:
		...
		ResampleDlgBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE|wxTAB_TRAVERSAL );
		~ResampleDlgBase();
...
class OptionsDlgBase : public wxDialog 
{
	...
	protected:
		...
		wxCheckBox* m_check_hide_unknown;
...
class TileDlgBase : public wxDialog 
{
	...
	public:
		...
		TileDlgBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 375,541 ), long style = wxDEFAULT_DIALOG_STYLE|wxTAB_TRAVERSAL );
		~TileDlgBase();
