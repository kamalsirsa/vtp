...
# ADD LINK32 wxmsw240d.lib osgd.lib osgDBd.lib osgUtild.lib osgTextd.lib libpng.lib zlib.lib gdal_id.lib opengl32.lib jpeg.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmt.lib" /nodefaultlib:"msvcrt.lib" /pdbtype:sept /libpath:"\APIs\plib-1.3.1\lib\Debug" /libpath:"\APIs\NetCDF" /libpath:"\APIs\libpng-1.0.8"
...
# ADD LINK32 wxmsw240u.lib osg.lib osgDB.lib osgUtil.lib osgText.lib libpng.lib zlib.lib gdal_i.lib opengl32.lib glu32.lib jpeg.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libc.lib" /out:"Release_Unicode/CManager_u.exe"
# SUBTRACT LINK32 /debug
