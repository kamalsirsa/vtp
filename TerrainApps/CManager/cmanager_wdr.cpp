...
wxSizer *PropDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxButton *item11 = new wxButton( parent, ID_ADDTAG, _("Add"), wxDefaultPosition, wxSize(35,-1), 0 );
    item9->Add( item11, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxButton *item12 = new wxButton( parent, ID_REMOVETAG, _("Remove"), wxDefaultPosition, wxSize(55,-1), 0 );
    item9->Add( item12, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxButton *item13 = new wxButton( parent, ID_EDITTAG, _("Edit"), wxDefaultPosition, wxSize(40,-1), 0 );
...
wxSizer *TagDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxButton *item8 = new wxButton( parent, wxID_OK, _("OK"), wxDefaultPosition, wxSize(40,-1), 0 );
    item7->Add( item8, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxButton *item9 = new wxButton( parent, wxID_CANCEL, _("Cancel"), wxDefaultPosition, wxSize(60,-1), 0 );
