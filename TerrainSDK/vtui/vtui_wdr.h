...
const int ID_HEIGHT1 = 10086;
const int ID_HEIGHT2 = 10087;
const int ID_RF = 10088;
const int ID_CURVATURE = 10089;
const int ID_LINE2 = 10090;
const int ID_STATUS_TEXT = 10091;
wxSizer *ProfileDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROJ = 10092;
const int ID_SHOW_ALL_DATUMS = 10093;
const int ID_DATUM = 10094;
const int ID_ELLIPSOID = 10095;
const int ID_HORUNITS = 10096;
const int ID_ZONE = 10097;
const int ID_PROJPARAM = 10098;
const int ID_STATEPLANE = 10099;
const int ID_PROJ_LOAD = 10100;
const int ID_PROJ_SAVE = 10101;
wxSizer *ProjectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATEPLANES = 10102;
const int ID_NAD27 = 10103;
const int ID_NAD83 = 10104;
const int ID_RADIO_METERS = 10105;
const int ID_RADIO_FEET = 10106;
const int ID_RADIO_FEET_US = 10107;
wxSizer *StatePlaneDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EDIT_PANEL = 10108;
const int ID_ADD_POINT = 10109;
const int ID_MOVE_POINT = 10110;
const int ID_REMOVE_POINT = 10111;
const int ID_SAVE_PROF = 10112;
const int ID_SAVE_AS_PROF = 10113;
const int ID_LOAD_PROF = 10114;
