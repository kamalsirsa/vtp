...
const int ID_CONSTANT_TOP = 10047;
wxSizer *LinearStructDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_RADIO_CONTENT = 10048;
const int ID_CHOICE_FILE = 10049;
const int ID_CHOICE_TYPE = 10050;
const int ID_CHOICE_ITEM = 10051;
const int ID_RADIO_MODEL = 10052;
const int ID_MODEL_FILE = 10053;
const int ID_BROWSE_MODEL_FILE = 10054;
const int ID_LOCATION = 10055;
wxSizer *InstanceDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_MAP_OFFSET = 10056;
const int ID_UNITS1 = 10057;
const int ID_MAP_DIST = 10058;
const int ID_UNITS2 = 10059;
const int ID_GEOD_DIST = 10060;
const int ID_UNITS3 = 10061;
const int ID_GROUND_DIST = 10062;
const int ID_UNITS4 = 10063;
const int ID_VERTICAL = 10064;
const int ID_UNITS5 = 10065;
wxSizer *DistanceDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_CMAP_FILE = 10066;
const int ID_RELATIVE = 10067;
const int ID_BLEND = 10068;
const int ID_COLORLIST = 10069;
const int ID_CHANGE_COLOR = 10070;
const int ID_DELETE_ELEVATION = 10071;
const int ID_HEIGHT_TO_ADD = 10072;
const int ID_ADD = 10073;
const int ID_SAVE_CMAP = 10074;
const int ID_SAVE_AS_CMAP = 10075;
const int ID_LOAD_CMAP = 10076;
wxSizer *ColorMapDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LINE_OF_SIGHT = 10077;
const int ID_VISIBILITY = 10078;
const int ID_FRESNEL = 10079;
const int ID_USE_EFFECTIVE = 10080;
const int ID_HEIGHT1 = 10081;
const int ID_HEIGHT2 = 10082;
const int ID_RF = 10083;
const int ID_CURVATURE = 10084;
const int ID_LINE2 = 10085;
const int ID_STATUS_TEXT = 10086;
wxSizer *ProfileDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROJ = 10087;
const int ID_SHOW_ALL_DATUMS = 10088;
const int ID_DATUM = 10089;
const int ID_ELLIPSOID = 10090;
const int ID_HORUNITS = 10091;
const int ID_ZONE = 10092;
const int ID_PROJPARAM = 10093;
const int ID_STATEPLANE = 10094;
const int ID_PROJ_LOAD = 10095;
const int ID_PROJ_SAVE = 10096;
wxSizer *ProjectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATEPLANES = 10097;
const int ID_NAD27 = 10098;
const int ID_NAD83 = 10099;
const int ID_RADIO_METERS = 10100;
const int ID_RADIO_FEET = 10101;
const int ID_RADIO_FEET_US = 10102;
