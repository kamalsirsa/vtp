...
const int ID_EXPORT_CSV = 10095;
wxSizer *ProfileDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROJ = 10096;
const int ID_SHOW_ALL_DATUMS = 10097;
const int ID_DATUM = 10098;
const int ID_ELLIPSOID = 10099;
const int ID_HORUNITS = 10100;
const int ID_ZONE = 10101;
const int ID_PROJPARAM = 10102;
const int ID_STATEPLANE = 10103;
const int ID_SET_EPSG = 10104;
const int ID_PROJ_LOAD = 10105;
const int ID_PROJ_SAVE = 10106;
wxSizer *ProjectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATEPLANES = 10107;
const int ID_NAD27 = 10108;
const int ID_NAD83 = 10109;
const int ID_RADIO_METERS = 10110;
const int ID_RADIO_FEET = 10111;
const int ID_RADIO_FEET_US = 10112;
wxSizer *StatePlaneDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EDIT_PANEL = 10113;
const int ID_ADD_POINT = 10114;
const int ID_MOVE_POINT = 10115;
const int ID_REMOVE_POINT = 10116;
const int ID_SAVE_PROF = 10117;
const int ID_SAVE_AS_PROF = 10118;
const int ID_LOAD_PROF = 10119;
wxSizer *ProfileEditDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TAGLIST = 10120;
wxSizer *TagDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXT_SHOW = 10121;
const int ID_CHOICE_SHOW = 10122;
const int ID_TEXT_VERTICAL = 10123;
const int ID_CHOICE_VERTICAL = 10124;
const int ID_DEL_HIGH = 10125;
const int ID_LIST = 10126;
wxSizer *FeatureTableDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_TEXTCTRL = 10127;
const int ID_SLIDER_RATIO = 10128;
const int ID_TEXT_X = 10129;
const int ID_TEXT_Y = 10130;
