...
const int ID_PROJ = 10094;
const int ID_SHOW_ALL_DATUMS = 10095;
const int ID_DATUM = 10096;
const int ID_ELLIPSOID = 10097;
const int ID_HORUNITS = 10098;
const int ID_ZONE = 10099;
const int ID_PROJPARAM = 10100;
const int ID_STATEPLANE = 10101;
const int ID_PROJ_LOAD = 10102;
const int ID_PROJ_SAVE = 10103;
wxSizer *ProjectionDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATEPLANES = 10104;
const int ID_NAD27 = 10105;
const int ID_NAD83 = 10106;
const int ID_RADIO_METERS = 10107;
const int ID_RADIO_FEET = 10108;
const int ID_RADIO_FEET_US = 10109;
wxSizer *StatePlaneDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_EDIT_PANEL = 10110;
const int ID_ADD_POINT = 10111;
const int ID_MOVE_POINT = 10112;
const int ID_REMOVE_POINT = 10113;
const int ID_SAVE_PROF = 10114;
const int ID_SAVE_AS_PROF = 10115;
const int ID_LOAD_PROF = 10116;
