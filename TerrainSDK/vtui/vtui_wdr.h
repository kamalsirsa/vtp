...
const int ID_LINE_OF_SIGHT = 10074;
const int ID_VISIBILITY = 10075;
const int ID_FRESNEL = 10076;
const int ID_USE_EFFECTIVE = 10077;
const int ID_HEIGHT1 = 10078;
const int ID_HEIGHT2 = 10079;
const int ID_RF = 10080;
const int ID_CURVATURE = 10081;
const int ID_LINE2 = 10082;
const int ID_STATUS_TEXT = 10083;
wxSizer *ProfileDialogFunc( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROJ = 10084;
const int ID_SHOW_ALL_DATUMS = 10085;
const int ID_DATUM = 10086;
const int ID_ELLIPSOID = 10087;
const int ID_HORUNITS = 10088;
const int ID_ZONE = 10089;
const int ID_PROJPARAM = 10090;
const int ID_STATEPLANE = 10091;
const int ID_PROJ_LOAD = 10092;
const int ID_PROJ_SAVE = 10093;
